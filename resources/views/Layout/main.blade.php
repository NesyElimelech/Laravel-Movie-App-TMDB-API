...
<body class="font-sans mx-auto bg-gradient-to-r from-gray-800 to-gray-900 text-white">
    {{-- Main layouts for the app --}}
    {{-- Navigation --}}
    <nav class="border-b border-gray-300">
        <div class="container mx-auto flex flex-col md:flex-row items-center justify-between px-4 py-6">
            ...
            <div class="flex flex-col md:flex-row items-center ">
                ...
                <div class="md:ml-4 mt-3 md:mt-0 flow-auto">
                    <a href="#">
                        <img src="https://media-exp1.licdn.com/dms/image/C4D03AQGKjwKKs36P8w/profile-displayphoto-shrink_200_200/0?e=1606953600&v=beta&t=LvlO6z-AoCuae_iunHXAK9hUTww_mFnzpyJJuJh5Qjg" alt="Avatar" class="rounded-full w-8 h-7 md:w-8 md:h-8">
                    </a>
                </div>
            </div>
        </div>
    ...
    <footer class="border border-t border-gray-800">
        <div class="container grid justify-center mx-auto text-sm px-4 py-6">
            <div class=" ">
                <span class="mr-2">&copy;</span>Powered by <a href="https://www.themoviedb.org/documentation/api" class="underline hover:text-gray-300 ml-2">TMDB API</a>
            </div>
        </div>
    </footer>
    @livewireScripts
