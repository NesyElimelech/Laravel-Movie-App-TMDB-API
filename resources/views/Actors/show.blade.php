...
@section('movies')
    <div class="movie-info">
        <div class="container mx-auto items-center md:items-start px4 py-4 md:pt-16 flex flex-col md:flex-row">
            ...
            <div class="ml-5 mr-5 md:ml-24 mt-4 md:mt-0">
                ...
                <h4 class="text-orange-500 text-3xl font-semibold mt-12">Known For</h4>
    ...
    <div class="credits">
        <div class="container mx-auto px-4 py-4 md:py-2">
            <h2 class="text-4xl font-semibold text-orange-500">Credits</h2>
            <ul class="list-disc leading-loose pl-5 mt-6">
